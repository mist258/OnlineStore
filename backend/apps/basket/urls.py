...
urlpatterns = [
    ...
    path('/update/<int:basket_id>/basket_item/<int:basket_item_id>', UpdateBasketItemView.as_view(), name='basket_update'),
    path('/delete/<int:basket_id>/basket_item/<int:basket_item_id>', DeleteBasketItemView.as_view(), name='basket_delete'),
