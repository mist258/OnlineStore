    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zip_code', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator('^(\\d{5}(-\\d{4})?|[A-Z]\\d[A-Z][ -]?\\d[A-Z]\\d|[A-Z]{1,2}\\d[A-Z\\d]?\\s?\\d[A-Z]{2})$', 'Zip code format must be as follows: 12345, 12345-6789, K1A 0B1, SW1A 1AA, 75008, 01001')])),
                ('phone_number', models.CharField(max_length=15, unique=True, validators=[django.core.validators.RegexValidator('^[\\+]?[(]?[0-9]{3}[)]?[-\\s\\.]?[0-9]{3}[-\\s\\.]?[0-9]{4,6}$', 'The number format must be as follows: +919367788755, 8989829304, +16308520397, 786-307-3615')])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
